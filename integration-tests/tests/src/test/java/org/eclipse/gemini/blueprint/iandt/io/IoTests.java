...
import org.eclipse.gemini.blueprint.iandt.compliance.io.BaseIoTest;
...
public class IoTests extends BaseIoTest
{
	...
	public void testFileOutsideOSGi() throws Exception {
		...
		Resource osgiResource = patternLoader.getResource(fileLocation);
	...
	public void testNonExistentFileOutsideOSGi() throws Exception {
		...
		Resource nonExistingFileOutsideOsgi = patternLoader.getResource(nonExistingLocation);

 ...
 * 
 */
@ContextConfiguration (locations = {"classpath:org/eclipse/gemini/blueprint/iandt/servicedependency/single-export-multi-import.xml"})
public class SingleExportDependingOnMultipleImportTest extends BaseIntegrationTest {
	...
	public Option[] getExtraConfig()
	{
		return options(
				...
				mavenBundle("org.eclipse.gemini.blueprint.iandt", "simple.service2").versionAsInProject()
		);
	}

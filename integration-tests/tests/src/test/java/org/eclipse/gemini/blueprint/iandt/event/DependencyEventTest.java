 ...
 * 
 */
public abstract class DependencyEventTest extends AbstractEventTest {

	private List<OsgiBundleApplicationContextEvent> refreshEvents =
			Collections.synchronizedList(new ArrayList<OsgiBundleApplicationContextEvent>(10));
	...
	public void testEventsForCtxThatWork() throws Exception {
		...
		final Bundle bnd = installTestBundle("dependencies");
		final Bundle bnd1 = installTestBundle("simple.service");
		final Bundle bnd2 = installTestBundle("simple.service2");
		final Bundle bnd3 = installTestBundle("simple.service3");

...
public abstract class AbstractEventTest extends BaseIntegrationTest {
	...
	/** list of events */
	protected List<OsgiBundleApplicationContextEvent> eventList = Collections.synchronizedList(new ArrayList<OsgiBundleApplicationContextEvent>());
	/** lock */
